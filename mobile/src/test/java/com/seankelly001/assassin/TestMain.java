...
public class TestMain {
    ...
    public void pictureMessageTest() throws Exception {
        ...
        for(int i = 0; i < message_bytes.length; i += (image_bytes_size)) {
            byte[] image_byte_message = MessageUtils.createSubImageMessage('J', message_bytes, current_sub_array_count, total_sub_array_count, i, image_bytes_size);
            MessageUtils.receivedSubPictureMessage(image_byte_message, picture_byte_array_list);
    ...
    public void textMessageTestPass() throws Exception {
        ...
        byte[] test_bytes = MessageUtils.createStringMessage('t', inital_string);
        String test_string = MessageUtils.decodeStringMessage(test_bytes);
    ...
    public void coordinateMessageTestPass() throws Exception {
        ...
        byte[] test_bytes = MessageUtils.createCoordinateMessage('E', lat_lng);
        LatLng test_lat_lng = MessageUtils.decodeCoordinateMessage(test_bytes);
